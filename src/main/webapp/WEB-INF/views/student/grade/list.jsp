                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="header smaller lighter blue">
                                ...
                                <sec:authorize ifAnyGranted="OPT_STUDENT_GRADE_ADD">
                            ...
                            <table id="simple-table" class="table  table-bordered table-hover">
                                ...
                                <c:forEach items="${grades}" var="grade" varStatus="vs">
                                    <tr id="tr-${grade.id}">
                                        ...
                                        <td>
                                            <fmt:formatNumber value="${grade.avgScore}" pattern="##.##"></fmt:formatNumber>

                                        </td>

                                        <td>
                                            <a title="编辑" href="student/grade/edit.do?id=${grade.id}"
                                               class="green">
                                                <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                            </a>
                                        </td>
                                        <td>
                                            <a title="删除" class="btn-delete-modal red" data-url="student/grade/delete.do"
