                        ...
                        <div class="col-xs-12">
                            ...
                            <form action="student/student/save_${cmd}.do" method="post" class="form-horizontal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="name" name="name" value="<c:out value="${student.name}"></c:out>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="studentNumber" name="studentNumber" value="${student.studentNumber}"
                                               class="col-xs-10 col-sm-5"/>
                                    </div>
                                </div>
                                <!--性别-->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label>
                                            <input id="male" name="gender" type="radio" class="ace" value="0"/>
                                            <span class="lbl" style="font-size: 18px">男</span>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input id="female" name="gender" type="radio" class="ace" value="1"/>
                                            <span class="lbl" style="font-size: 18px">女</span>
                                        </label>
                                    </div>
                                </div>
                                <!--出生日期-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="col-sm-5" id="grade" name="gradeId">
