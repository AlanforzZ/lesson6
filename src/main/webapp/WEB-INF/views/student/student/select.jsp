...
<![endif]-->
		...
		<script type="text/javascript">
            jQuery(function($){
                var demo1 = $('select[name="new_subjects"]').bootstrapDualListbox({infoTextFiltered: '<span class="label label-purple label-lg">Filtered</span>'});
                ...
                $(document).one('ajaxloadstart.page', function(e) {
                    ...
                    $('select[name="new_subjects"]').bootstrapDualListbox('destroy');
                    $('.rating').raty('destroy');
                            ...
                            <form action="student/student/save_${cmd}.do" method="post" class="form-horizontal"
                                ...
                                <input type="hidden" name="id" id="id" value="${student.id}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="pos-rel">
                                                <input class="typeahead scrollable" type="text" disabled="disabled" value="${student.name}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> 选课列表 </label>

                                        <div class="col-sm-8">
                                            <select multiple="multiple" size="10" name="new_subjects" id="duallist">

                                                <c:forEach items="${notSelectSubjects}" var="subject">
                                                <option value="${subject.id}">${subject.name}</option>
                                                </c:forEach>

                                                <c:forEach items="${student.scoreList}" var="score">
                                                <option selected="selected" value="${score.subject.id}">${score.subject.name}</option>
                                                </c:forEach>
                                            </select>
